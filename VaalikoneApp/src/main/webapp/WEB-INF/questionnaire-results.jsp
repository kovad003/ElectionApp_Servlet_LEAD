...
-->
    ...
    <div class="container">
        ...
        <h5>Thank you for succsessfully completing our questionnaire!
        ...
        <div class="container8">
            ...
            <h5>Q1: "I think that parliament should do more for the environment...""
                ...
                <!-- AD - Buttons to amend answer-->
                <div class="container7">
                <button class="button-main button1"><b>AMEND</b></button>
                </div>
            </h5>
        </div>
        ...
        <div class="container6">
            ...
            <h5>Suitable candidate number 1:
                <br><br>
                Mikki Savolainen
                <br><br>
         ...
         <div class="container6">
            <!-- AD - Overview info about the matched candidate -->
            <h5>Suitable candidate number 2:
                <br><br>
                Sara Koskinen
                <br><br>
                Overview: I care deeply about the environment and social issue.
         ...
         <div class="container6">
            <!-- AD - Overview info about the matched candidate -->
            <h5>Suitable candidate number 3:
                <br><br>
                Timo Salomaa
                <br><br>
                Overview: I care deeply about the environment and social issue.
