            ...
            <form id="form" action="/SubmitAnswer" method="POST">
                ...
                <div class="container5a">                  
                    ...
                    <div class="input-radio">                  
                        ...
                        <c:forEach begin="0" end="18" var="answerList" items="${requestScope.answerList}" >

							<div class = "containerDynamicQuestion">
					        <h3><c:out value = "${answerList.CId}) ${answerList.QTxt}"/></h3> <!-- Display question -->
					    	</div>
                                <!-- ******************************************************************************************************** -->
                                    
                                    <input hidden ="question_text" type = "text" name = "candidate_id"  value="${answerList.CId}">
                                    ...
                                    <label> <b>(1)</b>
                                    <input type = "radio" name = "selected${answerList.QId}"  value="1" ${answerList.answer=='1'?'checked':''}>
                                    </label>
                                    <label> <b>(2)</b>
                                    <input type = "radio" name = "selected${answerList.QId}" value = "2" ${answerList.answer=='2'?'checked':''}>
                                    </label>
                                    <label> <b>(3)</b>
                                    <input type = "radio" name = "selected${answerList.QId}" value = "3" ${answerList.answer=='3'?'checked':''}>
                                    </label>
                                    <label> <b>(4)</b>
                                    <input type = "radio" name = "selected${answerList.QId}" value = "4" ${answerList.answer=='4'?'checked':''}>
                                    </label>
                                    <label> <b>(5)</b>
                                    <input type = "radio" name = "selected${answerList.QId}" value = "5" ${answerList.answer=='5'?'checked':''}>
                                    </label>                                                      
